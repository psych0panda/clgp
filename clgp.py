...
def git_cmd(*cmd_args):
    """
    Run console command "git <cmd_args>"
    :param: str
    :return: None
    """
        ...
        if is_tool("git"):
            if is_git_repository(args.local_repo):
                if args.remote_repo:
                    ...
                    git_cmd('git', 'pull', args.remote_repo, args.http_proxy)
                    break
                else:
                    ...
                    if remote_url is False:
                        ...
                        break
                    git_cmd('git', 'pull', remote_url, args.http_proxy)
                    break
            else:
